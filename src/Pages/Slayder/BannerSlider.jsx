  ...
  return (
    <div className="w-full max-w-5xl mx-auto mt-8">
      <Slider {...settings}>
        ...
        {/* Slide 2 */}
        <div className="relative bg-green-500 text-white text-center h-[400px] rounded-lg overflow-hidden flex flex-col justify-center items-center px-4">
        ...
        {/* Slide 3 */}
        <div className="relative bg-purple-500 text-white text-center h-[400px] rounded-lg overflow-hidden flex flex-col justify-center items-center px-4">
