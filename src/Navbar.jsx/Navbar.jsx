...
const Navbar = () => {
  ...
  const links = (
    <>
      ...
      <li><NavLink to="/addRoommate" className="nav-link">Add Roommate</NavLink></li>
      <li><NavLink to="/browseListings" className="nav-link">Browse Listings</NavLink></li>
      <li><NavLink to="/myListing" className="nav-link">My Listing</NavLink></li>
      <li><NavLink to="/myPage" className="nav-link">My Page</NavLink></li>
